...
export function processConnectionPackageData(inputData) {
...
export function processNewCooperativeData(inputData) {
...
export function validatePassport(series, number) {
